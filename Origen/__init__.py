...
class ActionCustomImportPlugin(pcbnew.ActionPlugin):
    ...
    def defaults(self):
        self.name = "Custom Import GUI (fallback pcbnew)"
        self.category = "Import library files"
        self.description = "Importador de librerías personalizable - Import desde Octopart, Samacsys, Ultralibrarian, Snapeda y EasyEDA"
...
ActionCustomImportPlugin().register()
