...
class impartGUI ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Custom Import GUI", pos = wx.DefaultPosition, size = wx.Size( 650,650 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.BORDER_DEFAULT )
        ...
        self.m_button_migrate = wx.Button( self, wx.ID_ANY, u"Migrate libraries (highly recommended)", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_autoImport = wx.CheckBox( self, wx.ID_ANY, u"automatic import in background", wx.DefaultPosition, wx.DefaultSize, 0 )
        fgSizer1.Add( self.m_autoImport, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )

        self.m_overwrite = wx.CheckBox( self, wx.ID_ANY, u"overwrite existing libraries", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_check_autoLib = wx.CheckBox( self, wx.ID_ANY, u"automatic KiCad configuration", wx.DefaultPosition, wx.DefaultSize, 0 )
        fgSizer1.Add( self.m_check_autoLib, 0, wx.ALL, 5 )

        bSizer.Add( fgSizer1, 0, wx.ALIGN_CENTER, 5 )

        self.m_staticText_sourcepath = wx.StaticText( self, wx.ID_ANY, u"Library folder to import:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_hyperlink = wx.adv.HyperlinkCtrl( self, wx.ID_ANY, u"github.com/safloresmo/CustomImportGUI", u"https://github.com/safloresmo/CustomImportGUI", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
